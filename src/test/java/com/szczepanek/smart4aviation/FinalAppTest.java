...
class FinalAppTest {
    ...
    void getFlightWeight() {
        finalApp.setFlightsFilePath("src/test/java/com/szczepanek/smart4aviation/testdata/flightsTest_data.json");
        finalApp.setCargosFilePath("src/test/java/com/szczepanek/smart4aviation/testdata/cargosTest_data.json");
